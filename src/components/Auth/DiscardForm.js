...
function DiscardForm() {
    const { dataForm, setOpenFormDiscard } = UserAuth(); //dataForm: Chứa thông tin về form, như tiêu đề và hàm xử lý khi hủy bỏ.
    // setOpenFormDiscard: Hàm để đóng modal hủy bỏ.
